...
class CausalConv1D(nn.Conv1d):
    ...
    def forward(self, x, cache=None, cache_next=None):
        x = self.do_caching(x, cache=cache, cache_next=cache_next)
        x = super().forward(x)
        return x
